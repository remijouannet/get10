...
public class GraphicHelper {
    ...
    public static void createPrograms(String fileVs, String fileFs) {
        ...
        vertexShader = GraphicHelper.loadShader(
                GLES20.GL_VERTEX_SHADER, GraphicHelper.vertexShaderString);
        fragmentShader = GraphicHelper.loadShader(
                GLES20.GL_FRAGMENT_SHADER, GraphicHelper.fragmentShaderString);

        GraphicHelper.shaderProgram = GLES20.glCreateProgram();
        GLES20.glAttachShader(GraphicHelper.shaderProgram, vertexShader);   // add the vertex shader to program
        GLES20.glAttachShader(GraphicHelper.shaderProgram, fragmentShader); // add the fragment shader to program
        GLES20.glLinkProgram(GraphicHelper.shaderProgram);                  // create OpenGL program executables
